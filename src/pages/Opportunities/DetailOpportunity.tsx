            ...
            <table className="lead-table">
              <thead>
                <tr className="bg-[#C32033] shadow-lg text-white">
                  ...
                  {columnOrder
                    .filter(
                      (key) => key !== "LAST_UPDATE_DATE" && key !== "CREATION_DATE"
                    )
                    .map((key, index) => (
                      <th
                        key={key}
                        className={`px-6 py-4 text-center ${key === "DESCRIPTION" ? "min-w-[300px] max-w-[500px]" : ""
                          }`}
                      >
                        {key
                          .replace(/_/g, " ")
                  ...
                  >
                    ...
                    {columnOrder
                      ...
                      .map((key) => (
                        <td
                          key={key}
                          className={`px-6 py-5 ${key === "DESCRIPTION" ? "whitespace-normal break-words" : ""
                            }`}
                        >
                          {String(line[key] ?? "-")}
                        </td>
