...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`z-9999 w-80 fixed top-0 left-0 flex flex-col h-screen overflow-y-auto bg-white duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full'
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 pt-8 pb-7 bg-[#C32033] h-[80px]">
        <NavLink to="/">
          <img
            src={Logo}
            alt="Logo"
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li className="mb-1">
                <NavLink
                  to="/"
                  className={`group relative flex items-center gap-6 rounded-sm py-2 px-4 font-medium text-black text-lg duration-300 ease-in-out hover:bg-[#FFD7D7] ${
                    pathname === '/' ? 'bg-[#FFD7D7] text-black' : ''
                  }`}
                >
                  <svg
                    className="fill-current text-[#C32033]"
                    width="30"
                    height="30"
                    viewBox="0 0 18 18"
                    fill="none"
              ...
              {/* <li className="mb-1">
                <NavLink
                  to="/calendar"
                  className={`group relative flex items-center gap-6 rounded-sm py-2 px-4 font-medium text-black text-lg duration-300 ease-in-out hover:bg-[#FFD7D7] ${
                    pathname.includes('calendar') && 'bg-[#FFD7D7] text-black'
                  }`}
                >
                  <svg
                    className="fill-current text-[#C32033]"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-6 rounded-sm py-2 mb-1 px-4 font-medium text-black text-lg duration-300 ease-in-out hover:bg-[#FFD7D7] ${
                          (pathname === '/forms' ||
              ...
              <li className="mb-1">
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-6 rounded-sm py-2 px-4 font-medium text-black text-lg duration-300 ease-in-out hover:bg-[#FFD7D7] ${
                    pathname.includes('profile') && 'bg-[#FFD7D7] text-black'
                  }`}
                >
                  <svg
                    className="fill-current text-[#C32033]"
              ...
              {/* <li className="mb-1">
                <NavLink
                  to="/tables"
                  className={`group relative flex items-center gap-6 rounded-sm py-2 px-4 font-medium text-black text-lg duration-300 ease-in-out hover:bg-[#FFD7D7] ${
                    pathname.includes('tables') && 'bg-[#FFD7D7] text-black'
                  }`}
                >
                  <svg
                    className="fill-current text-[#C32033]"
              ...
              {/* <li className="mb-1">
                <NavLink
                  to="/settings"
                  className={`group relative flex items-center gap-6 rounded-sm py-2 px-4 font-medium text-black text-lg duration-300 ease-in-out hover:bg-[#FFD7D7] ${
                    pathname.includes('settings') && 'bg-[#FFD7D7] text-black'
                  }`}
                >
                  <svg
                    className="fill-current text-[#C32033]"
          ...
          {/* <!-- Others Group --> */}
          <div>
            {/* <h3 className="mb-4 ml-4 text-lg font-semibold text-[#C32033]">
              OTHERS
            </h3> */}
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <li className="mb-1">
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-6 rounded-sm py-2 px-4 font-medium text-black text-lg duration-300 ease-in-out hover:bg-[#FFD7D7] ${
                    pathname.includes('chart') && 'bg-[#FFD7D7] text-black'
                  }`}
                >
                  <svg
                    className="fill-current text-[#C32033]"
